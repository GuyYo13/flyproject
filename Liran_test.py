...
for message in consumer:
    ...
    try:
        ...
        values = (airline, flight_number, origin, destination, departure_time, arrival_time)
...
# Get the row count from the flights table
row_count_query = '''SELECT COUNT(*) FROM flights'''
cursor.execute(row_count_query)
row_count = cursor.fetchone()[0]

# Print the row count
print("Row count in flights table:", row_count)
